# =============================================================================
# pp3c_Stirling.py - Nội suy Stirling
#
# Chức năng: Nội suy bằng công thức Stirling dùng sai phân trung
#            tâm, tối ưu cho các điểm đối xứng quanh điểm nội suy.
#
# Các hàm chính:
#   parse_xy_data(filepath)             - đọc dữ liệu từ CSV
#   get_points_in_range(points, x0, n)  - chọn điểm đối xứng
#   stirling_interpolation(points, x0_index) - công thức Stirling
#   all_derivatives(coeffs, t, h)      - đạo hàm
#
# Cách dùng: python pp3c_Stirling.py
# =============================================================================
import numpy as np
import pandas as pd
import math
