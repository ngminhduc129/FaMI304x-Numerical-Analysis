# =============================================================================
# pp5c_CubicSpline.py - Nội suy Spline bậc 2 (tên file Cubic nhưng code Quad)
#
# Chức năng: Nội suy bằng các đoạn parabol nối trơn, liên tục C1.
#            (Lưu ý: tên file là CubicSpline nhưng code là Quadratic Spline)
#
# Các hàm chính:
#   quadratic_spline_interpolation(points, z0_condition)
#   evaluate_quadratic_spline(segments, x_val)
#
# Cách dùng: python pp5c_CubicSpline.py
# =============================================================================
import numpy as np
import pandas as pd
import math
