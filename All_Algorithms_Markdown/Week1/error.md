...
**Bước 3:** Tính sai số tuyệt đối giới hạn
...
**Bước 4:** Tính giá trị $V$ tại các giá trị đo
...
**Bước 1:** Xác định hàm số và yêu cầu
...
**Bước 3:** Áp dụng nguyên tắc ảnh hưởng ngang nhau
...
**Bước 1:** Xác định hàm số và sai số tương đối yêu cầu
- Hàm số: $S(\pi, R) = \pi R^2$.
- Yêu cầu: $\delta_S = \dfrac{\Delta_S}{S} \leq 0,01$.

**Bước 2:** Thiết lập phương trình sai số tương đối
- $\dfrac{\Delta_S}{S} = \dfrac{\Delta_\pi}{\pi} + 2\dfrac{\Delta_R}{R} = 0,01$.

**Bước 3:** Áp dụng nguyên tắc ảnh hưởng ngang nhau (hai đối số)
...
**Bước 4:** Tính sai số tuyệt đối cho phép
